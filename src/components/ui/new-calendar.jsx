...
const getCalendarOptions = (locale, weekStartsOn) =>
...
export const Calendar = ({
  ...
  const setMonthValue = (nextMonth) => {
    const normalized = startOfMonth(nextMonth);
    if (month === undefined) setInternalMonth(normalized);
    onMonthChange?.(normalized);
  };

  const setSelectedValue = (nextDate) => {
  ...
  const moveFocusToDate = (preferredDate, step) => {
...
const isYearOutOfRange = (year, minYear, maxYear) =>
